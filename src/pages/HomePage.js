...
const HomePage = () => {
  return (
    <div className="row home">
      <div className="col-md-6 home-lead">
        ...
        <p className="home-text"><span className='circle'></span>Chciałem Ci powiedzieć po krótce co tutaj robię. Mianowicie ta aplikacja współpracuje z REST API, dzięki któremu zapisywanie swoich zadań na dłużej to nie problem. Jest to swojego rodzaju test moich umiejętności jako Fullstack Developera.</p>
